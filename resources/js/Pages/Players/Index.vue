...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold text-gray-800 leading-tight">Jugadores</h2>
        </template>

        <div class="p-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                <button @click="showCreateModal = true" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition">
                    + Añadir Jugador
                </button>
                <input
                    v-model="search"
...
<!--                        <td class="p-4">{{ player.paddle_type || '—' }}</td>-->
                        ...
                        <td class="p-4">
                            ...
                            <button @click="destroyPlayer(player)" class="text-red-600 hover:underline ml-4">Eliminar</button>
                        </td>
                    </tr>
